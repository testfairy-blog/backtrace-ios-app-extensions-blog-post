...
typedef SWIFT_ENUM(NSInteger, BacktraceBreadcrumbLevel, closed) {
...
typedef SWIFT_ENUM(NSInteger, BacktraceBreadcrumbType, closed) {
...
@property (nonatomic) BOOL detectOom;
...
///
/// \param allowsAttachingDebugger if set to <code>true</code> BacktraceClient will report reports even when the debugger
/// is attached. Default: <code>false</code>.
///
...
///
- (nonnull instancetype)initWithCredentials:(BacktraceCredentials * _Nonnull)credentials dbSettings:(BacktraceDatabaseSettings * _Nonnull)dbSettings reportsPerMin:(NSInteger)reportsPerMin allowsAttachingDebugger:(BOOL)allowsAttachingDebugger detectOOM:(BOOL)detectOOM OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
/// Logging levels.
typedef SWIFT_ENUM(NSInteger, BacktraceLogLevel, closed) {
...
typedef SWIFT_ENUM(NSInteger, BacktraceReportStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, RetryBehaviour, closed) {
...
typedef SWIFT_ENUM(NSInteger, RetryOrder, closed) {
